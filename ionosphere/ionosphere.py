...
results_random_fs = random_FS_classif_RF_1_vs_all(features, k=5, labels=labels)
results_qubo_fs = QUBO_FS_classif_RF_1_vs_all(features, k=5, labels=labels)
...
plt.xlabel('Labels of ionosphere')
plt.ylabel('Accuracy')
plt.ylim(0.2, 1)
